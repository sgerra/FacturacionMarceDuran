Imports Facturacion.pltFacturacion
Public Class FormBuscarArticulos
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            'Descripcion
            GrillaArticulos.Columns("descri").HeaderText = "Descripcion"
            GrillaArticulos.Columns("descri").Width = 100
            GrillaArticulos.Columns("descri").Visible = True
            GrillaArticulos.Columns("descri").ReadOnly = True
            GrillaArticulos.Columns("descri").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft
            ...
            'Precio
            GrillaArticulos.Columns("precio").HeaderText = "Precio"
            GrillaArticulos.Columns("precio").Width = 80
            GrillaArticulos.Columns("precio").Visible = True
            GrillaArticulos.Columns("precio").ReadOnly = True
            GrillaArticulos.Columns("precio").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft
            iniciando = False
    ...
    Private Sub txtdescri_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtdescri.TextChanged
        ...
        If Not iniciando Then
            ...
            filas = dt.Select("descri LIKE '" & txtdescri.Text & "%'")
