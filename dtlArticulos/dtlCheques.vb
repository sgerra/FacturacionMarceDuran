...
Public Class dtlCheques
    Public Shared Function obtenerRegistro(ByVal lngIdPde As Long, ByVal cadena As String) As DataSet
        ...
        Try
            ...
            command.CommandText = "Cheques_obtenerRegistro"
            command.Parameters.Add(New SqlParameter("@pcp_idpcp", lngIdPde))
    ...
    Public Shared Function obtenerLista(ByVal cadena As String) As DataSet
        ...
        Try
            ...
            command = New SqlCommand()
            command.CommandType = CommandType.StoredProcedure
            command.CommandText = "Cheques_ObtenerLista"
            adapter = New SqlDataAdapter()
            adapter.SelectCommand = command
            adapter.SelectCommand.Connection = miConn
    ...
    Public Shared Function insertarRegistro(ByVal dsCompras As DataSet, ByVal cadena As String) As Long
        ...
        Try
            ...
            command.CommandType = CommandType.StoredProcedure
            command.CommandText = "Cheques_insertarRegistro"
    ...
    Public Shared Function EliminarRegistro(ByVal cadena As String, nroPago As Integer) As Boolean
        ...
        Try
            ...
            command.Connection = miConn
            command.CommandType = CommandType.StoredProcedure
            command.CommandText = "Cheques_EliminarRegistro"
            command.Parameters.Add(New SqlParameter("@pcp_nropago", nroPago))
