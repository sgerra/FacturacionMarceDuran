...
Public Class dtlCiudades
    Public Shared Function obtenerLista(ByVal cadena As String, lngIdPcia As Integer) As DataSet
        ...
        Try
            ...
            command.CommandText = "Ciudades_obtenerLista"
            command.Parameters.Add(New SqlParameter("@idProvincia", lngIdPcia))
