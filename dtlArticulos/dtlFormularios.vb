...
Public Class dtlFormularios
    Public Shared Function obtenerRegistro(ByVal cadena As String, ByVal strNombreFormu As String) As DataSet
        ...
        Try
            ...
            command.CommandText = "Formularios_obtenerRegistro"
            command.Parameters.Add(New SqlParameter("@nombreFormu", strNombreFormu))
