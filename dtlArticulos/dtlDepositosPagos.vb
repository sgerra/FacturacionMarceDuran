...
Public Class dtlDepositosPagos
    Public Shared Function obtenerRegistro(ByVal lngIdDep As Long, ByVal cadena As String) As DataSet
        ...
        Try
            ...
            command.CommandText = "DepositosPagos_obtenerRegistro"
            command.Parameters.Add(New SqlParameter("@dep_id", lngIdDep))
    ...
    Public Shared Function obtenerLista(ByVal cadena As String, lngTpoMoneda As Integer) As DataSet
        ...
        Try
            ...
            command = New SqlCommand()
            command.CommandType = CommandType.StoredProcedure
            command.CommandText = "DepositosPagos_ObtenerLista"
    ...
    Public Shared Function insertarRegistro(ByVal dsCompras As DataSet, ByVal cadena As String) As Long
        ...
        Try
            ...
            command.CommandType = CommandType.StoredProcedure
            command.CommandText = "DepositosPagos_insertarRegistro"
    ...
    Public Shared Function EliminarRegistro(ByVal cadena As String, nroPago As Integer) As Boolean
        ...
        Try
           miConn = New SqlConnection()
            ...
            command.Connection = miConn
            command.CommandType = CommandType.StoredProcedure
            command.CommandText = "DepositosPagos_EliminarRegistro"
            command.Parameters.Add(New SqlParameter("@dep_nropago", nroPago))
