...
Public Class dtlComprobantesVentaDetalle
    Public Shared Function obtenerRegistro(ByVal cadena As String, ByVal lngNroCom As Integer) As DataSet
        ...
        Try
            ...
            command.CommandText = "ComprobantesVentaDetalle_obtenerRegistro"
            command.Parameters.Add(New SqlParameter("@cvd_nrocom", lngNroCom))
        ...
        End Try
    End Function
    Public Shared Function insertarRegistro(ByVal cadena As String, ByVal dstComprobanteVentaDet As DataSet) As Long
        'Recupera un articulo de la base y lo guarda en un dataset 
        Dim miConn As SqlConnection
        ...
        Try
            ...
            For Each objField In dstComprobanteVentaDet.Tables(0).Columns
                par = New SqlParameter(objField.ColumnName, dstComprobanteVentaDet.Tables(0).Rows(0).Item(objField.Ordinal)) 'objField.MaxLength)
            ...
            command.CommandType = CommandType.StoredProcedure
            command.CommandText = "ComprobantesVentadetalle_insertarRegistro"
