...
Public Class FormBuscarArticulos
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            txtdescri.Text = ""
            GrillaArticulos.DataSource = pwiFacturacion.ObtenerLista(cadena).Tables(0)
            dt = pwiFacturacion.ObtenerLista(cadena).Tables(0)
            'codigo de articulo 
        ...
        If e.KeyChar = ChrW(Keys.Enter) Then
            ...
            For Each fila As DataGridViewRow In Me.GrillaArticulos.Rows
                ...
                If i > -1 Then
                    ...
                    AndAlso descripcion = fila.Cells("desc").Value.ToString Then
