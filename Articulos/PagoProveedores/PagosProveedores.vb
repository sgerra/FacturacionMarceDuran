...
Public Class PagosProveedores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AppFacturacion.PagosProveedores.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NroPago() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPagosProveedores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PagosProveedores = New PagosProveedores()
        rpt.Site = Me.Site
        Return rpt
    End Function
