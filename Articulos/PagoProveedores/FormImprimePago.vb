...
Public Class FormImprimePAgo
    ...
    Private Sub ImprimirReporte(ByVal NroPago As Integer)

        myReport = rpt
        rpt.FileName = Application.StartupPath & ("\PagosProveedores.rpt")
        inicializarConexion()
        rpt.SetParameterValue("NroPago", NroPago)
