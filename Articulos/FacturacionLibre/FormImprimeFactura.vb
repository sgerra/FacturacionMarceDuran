...
Public Class FormImprimeFactura
    Private myReport As New ReportDocument
    Public Sub AbrirFormulario(ByVal idFactura As Integer)
        ImprimirReporte(idFactura)
        Me.ShowDialog()
    End Sub

    Private Sub ImprimirReporte(ByVal idFactura As Integer)

        myReport = rpt
        rpt.FileName = Application.StartupPath & ("\factura.rpt")
        inicializarConexion()
        rpt.SetParameterValue("IdFactura", idFactura)
